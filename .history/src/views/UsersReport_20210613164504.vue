...
export default {
  ...
  methods: {
    setupLeafletMap: function() {
      ...
      L.tileLayer(
        "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoidW1hcnJnIiwiYSI6ImNrcHZjejJvMjB2MHQzMnF3aGtpcTh3ZjkifQ.EGb73hsPPgMJ25vCJ2Lr7w",
        {
          attribution:
          ...
          accessToken:
            "pk.eyJ1IjoidW1hcnJnIiwiYSI6ImNrcHZjc3A1ZzFoYjEyb3FreXI5dTdhMmEifQ.5r3o1olF0k01-XJpe6Vdhg",
        }
      ).addTo(mapDiv);
    },
